    ...
    private function seedHomeContent(array $categories): void
    {
        ...
        HomeSection::updateOrCreate(
            ...
            [
                ...
                'description_hy' => 'Վիդեո պատմություն VERTONI արհեստանոցի մասին՝ նյութի ընտրությունից մինչև վերջին կարը, հղկումը և պատրաստի տեսքը։',
                'description_ru' => 'Видеоистория мастерской VERTONI: от выбора кожи до последнего шва, обработки и готового изделия.',
                'description_en' => 'A short atelier story by VERTONI: from leather selection to the final stitch, finishing and finished piece.',
